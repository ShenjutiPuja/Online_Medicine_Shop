                        ...
                        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                            <div class="card" style="border-radius: 15px;">
                                <div class="card-body p-5" style="box-shadow: 0px 10px 20px 10px #888888;">
                                    <h2 class="text-uppercase text-center mb-5">Add a Medicine Item</h2>
                                    ...
                                    <form method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-outline mb-4" style="font-size: 20px; font-weight: bold;">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    style="margin-left: 40px;"> Yes
                                                    <input type="radio" name="featured" value="No" 
                                                    style="margin-left: 40px;"> No
                                                </td>
                                            </tr>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-center">
                                            <input type="submit" name="submit" value="Add Medicine" class="submit">
                                        </div>
...
if (isset($_POST['submit'])) {
    ...
    $sql2 = "INSERT INTO `tbl_medicine` SET `title` = '$title', `description` = '$description', `price` = '$price', `image_name` = '$image_name', `category_id` = '$category_id', `featured` = '$featured', `active` = '$active'";

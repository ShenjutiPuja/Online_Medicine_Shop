                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if ($image_name != "") {
                                    //display the image
                                ?>
                                    <img src="<?php echo SITEURL; ?>images/medicine/<?php echo $image_name; ?>" width="200px;">;
                                <?php
                                } else {
                            ...
                            <td>
                                <a href="<?php echo SITEURL ?>admin/update-medicine.php?id=<?php echo $id; ?>" class="btn-secondery"> Update Medicine </a>
                                <a href="<?php echo SITEURL ?>admin/delete-medicine.php?id=<?php echo $id; ?>" class="btn-third"> Delete Medicine </a>
                            </td>
                        </tr>
